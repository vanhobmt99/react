        ...
        <div className="flex flex-col justify-center items-center sm:bg-slate-600">
          <form className="max-w-[400px] w-full mx-auto bg-gray-200 p-8 px-8 rounded-lg">
            ...
            <div className="flex flex-col md:flex-row ">
              <button className="w-full p-2 bg-green-500 rounded-lg shadow-xl hover:bg-blue-700g my-2 md:mx-3 font-bold">
                Login
              </button>
              <button className="w-full p-2 bg-red-500 rounded-lg shadow-xl hover:bg-red-700g my-2 md:mx-3 font-bold">
                Register
              </button>
            </div>
          </form>
